...
public class DuctileResultSet implements ResultSet, DuctileWrapper {
    ...
    private final Iterator<TableRow> rowIterator;
    private TableRow row = null;

    public DuctileResultSet(DuctileConnection connection, TableRowIterable rows) {
	super();
	...
	try {
	    ...
	    throw new SQLException("Could not close rows iterator.", e);
	}
    }
	...
	throw new SQLException("Updates in result set are not suppored.");
    }
	...
	throw new SQLException("Inserts in result set are not suppored.");
    }
	...
	throw new SQLException("Deletes in result set are not suppored.");
    }

    @Override
    public void refreshRow() throws SQLException {
	throw new SQLException("Refreshs in result set are not suppored.");
    }
