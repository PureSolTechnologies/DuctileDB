...
class DuctileDBCacheEdge extends DuctileDBCacheElement implements DuctileDBEdge {
    ...
    public DuctileDBCacheEdge(DuctileDBGraphImpl graph, long id, String label, long startVertexId, long targetVertexId,
	...
	ElementUtils.setFinalField(cloned, DuctileDBCacheEdge.class, "label", label);
