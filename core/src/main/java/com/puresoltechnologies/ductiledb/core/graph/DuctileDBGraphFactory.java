...
public class DuctileDBGraphFactory {
    ...
    public static DatabaseEngineImpl createDatabaseEngine(DatabaseEngineConfiguration configuration)
    ...
    public static DuctileDBGraphImpl createGraph(BlobStoreImpl blobStore, DuctileDBConfiguration configuration)
