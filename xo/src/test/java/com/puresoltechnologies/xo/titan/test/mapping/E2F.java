...
public interface E2F {
	...
	@Gauging("_().outE.has('label', 'E2F').has('value', {value}).inV.has('"
			+ DuctileDBStoreSession.XO_DISCRIMINATORS_PROPERTY + "F')")
	...
	@Gauging(value = "_().outE.has('label', 'E2F').has('value', {value}).inV.has('"
			+ DuctileDBStoreSession.XO_DISCRIMINATORS_PROPERTY + "F')", name = "f")
