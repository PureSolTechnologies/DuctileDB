...
import com.puresoltechnologies.ductiledb.xo.test.transaction.A.ByValue;

@RunWith(Parameterized.class)
public class TransactionAttributeRequiresIT extends AbstractXODuctileDBTest {
	...
	return DuctileDBTestUtils.xoUnits(asList(A.class, B.class), Collections.<Class<?>> emptyList(),
		ValidationMode.AUTO, ConcurrencyMode.SINGLETHREADED, Transaction.TransactionAttribute.REQUIRES);
    }
